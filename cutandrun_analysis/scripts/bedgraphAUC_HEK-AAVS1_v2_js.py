...
elemDict = {'AAVS1':['chr19', 55600286, 55631005],
			...
			'IGF2':['chr11', 2148342, 2172833],
			'KCNQ1':['chr11', 2464238, 2872335],
			'WT1':['chr11', 32407321, 32459085],
			'MIR371A':['chr19', 54288929, 54292995],
			'ZIM2-MIMT1':['chr19', 57283915, 57361924],
			'GAPDH':['chr12', 6641683, 6649537],
			'UBC':['chr12', 125394192, 125401196],
			'TUBA1A':['chr12', 49576578, 49585107],
			'80KBDOMAIN':['chr19', 55586540, 55667730]
			}
...
antibodies = ['H3K9me3', 'H3K36me2', 'H3K36me3', 'H3K4me3', 'H3K27me3', 'HA-tag']
celltypes = ['K36M', 'PARENT']
conditions = ['nodox', '2dox', '6dox', 'offdox']
...
for file in os.listdir(inputDir):
	...
	with open(filepath, 'r') as bedgraph:
		...
		antibody = AbDict[file_contents[3]]
...
condOrder = ['nodox', '2dox', '6dox', 'offdox']
...
g = sns.catplot(data=df, x='Element', y='Signal per kb', hue='Condition',
				col='Antibody', row='Cell Type', kind='bar', height=4, aspect=1.5, palette=pal)
