...
if (argv_len < 5) | (argv_len > 6):
	...
	print('   5) Optional: Path to script for editing sam files')
	sys.exit()
...
for folder in os.listdir(inputDir_fastqzip):
	...
	bowtie2_cmd_full = bowtie2_cmd + inputRoot_refgenome + ' -p ' + cores + ' -1 ' + files[0] + ' -2 ' + files[1] + ' -S ' + aligned_path + ' 2> ' + alnstats_path
